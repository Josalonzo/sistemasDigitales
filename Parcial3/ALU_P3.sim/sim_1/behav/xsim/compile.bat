...
REM
REM Generated by Vivado on Wed Apr 22 23:36:35 -0600 2026
...
echo "xvlog --incr --relax -L uvm -prj Alu_vlog.prj"
call xvlog  --incr --relax -L uvm -prj Alu_vlog.prj -log xvlog.log
